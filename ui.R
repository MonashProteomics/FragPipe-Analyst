                        ...
                        tags$ul(
                          ...
                          tags$li("For MS1-based LFQ:",
                                  tags$ul(
                                    ...
                                    tags$li("Upload your ", tags$b("annotation file"), ". Check ", tags$a(href="https://github.com/MonashProteomics/FragPipe-Analyst/tree/main/docs", target="_blank", "here"), " for details.")
                                  )
                          ),
                          tags$li("For TMT:",
                                  tags$ul(
                                    ...
                                    tags$li("Upload your ", tags$b("experiment_annotation.tsv"), " file automatically generated by FragPipe. You will need to fill in the condition and replicate column before you upload the file to FragPipe-Analyst.")
                                  )
                          ),
                          tags$li("For DIA:",
                                  tags$ul(
