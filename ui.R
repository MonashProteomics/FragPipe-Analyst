      ...
      div(id="quickstart_info",
                    fluidPage(
                      box(
                        ...
                        tags$ul(
                          tags$li("Choose the type of experiment you performed. Currently, MS1-based LFQ, TMT, and DIA are supported."),
                          tags$li("For MS1-based LFQ:",
                                  tags$ul(
                                    tags$li("Upload your ", tags$b("combined_protein.tsv "), "generated by IonQuant in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
                                    tags$li("Upload your ", tags$b("FragPipe Manifest (.fp-manifest)"))
                                  )
                          ),
                          tags$li("For TMT:",
                                  tags$ul(
                                    tags$li("Upload your TMT-I gene report", tags$b("[abundance/ratio]_gene_[normalization].tsv"), "generated by ", tags$a(href="https://tmt-integrator.nesvilab.org/", target="_blank", "TMT-Integrator"), "(we recommend ", tags$b("abundance_gene_MD.tsv"), "file)."),
                                    tags$li("Upload the ", tags$b("combined_annotation.txt"), " file automatically generated by FragPipe. You will need to fill in the condition column before you upload the file to FragPipe-Analyst."),
                                    tags$li("Make sure your TMT-I gene report does not have duplicated column names (i.e., sample names). If there are duplicated column names, you can change the column name to this format: [original column name]_1 and [original column name]_2. Each replicate should also have a different name/row in the annotation tsv file.")
                                  )
                          ),
                          tags$li("For DIA:",
                                  tags$ul(
                                    tags$li("Upload protein group (PG) matrix (diann-output.pg_matrix.tsv as default name) generated by ", tags$a(href="https://github.com/vdemichev/DiaNN", target="_blank", "DIA-NN"), " in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
                                    tags$li("Upload your ", tags$b("FragPipe Manifest (.fp-manifest)"))
                                  )
                          ),
