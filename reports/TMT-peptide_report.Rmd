...
### Result output contains `r nrow(params$data)` peptides of which _`r nrow(params$dep())`_ peptides were reproducibly quantified.
...
Peptide expression distribution before and after imputation. The plot showing the effect of imputation on peptides' expression distribution.
